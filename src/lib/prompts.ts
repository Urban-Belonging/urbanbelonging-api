...
export type AnnotationAnswerType = 'single-choice' | 'multiple-choice' | 'slider';

export type CapturePromptType = 'general:thing-place-situation' | 'general:significant-experience';
...
export const CapturePrompts: Record<CapturePromptType, CapturePrompt> = {
  'general:thing-place-situation': {
    message: 'Take a picture of a thing/place/situation in your city that you want to share'
  },
...
export const AnnotationAnswerOptions: Record<AnnotationPromptType, (string | number)[]> = {
...
export const ReactionAnswerOptions: Record<ReactionPromptType, (string | number)[]> = {
